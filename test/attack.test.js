...
describe("Attack", function () {
  it("Should change the owner of the Good contract", async function () {
    ...
    const goodContractBal = myUtil.formatEther(await ethers.provider.getBalance(_goodContract.address))
    console.log(goodContractBal)
    console.log("Good Contract's Address:", _goodContract.address);
    expect(goodContractBal).to.eq("3.0")
